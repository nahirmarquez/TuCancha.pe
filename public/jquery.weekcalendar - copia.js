...
//TODO timeslotsPerDay *4
         for (var i = 0; i < options.timeslotsPerDay/4; i++) {
...
/*TODO:timeslotperhour=1 **/   
            options.timeslotsPerDay = 1 * (options.businessHours.end - options.businessHours.start);
            options.millisToDisplay = (options.businessHours.end - options.businessHours.start) * 60 * 60 * 1000;
            options.millisPerTimeslot = options.millisToDisplay / options.timeslotsPerDay;
         } else {
/*TODO:timeslotperhour=1 **/            
            options.timeslotsPerDay = 1 * 24;
...
/**TODO: TimesLotPerDay * 4 (recuperando longitud)**/
            $(this).height(options.timeslotHeight * options.timeslotsPerDay * 4);
            if (!options.readonly) {
