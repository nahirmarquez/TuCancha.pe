...
class EventoDeportivosControllerTest < ActionController::TestCase
  ...
  test "should create evento_deportivo" do
    assert_difference('EventoDeportivo.count') do
      post :create, evento_deportivo: { detalles_adicionales: @evento_deportivo.detalles_adicionales, fecha_fin: @evento_deportivo.fecha_fin, fecha_inicio: @evento_deportivo.fecha_inicio, horario: @evento_deportivo.horario, lugar: @evento_deportivo.lugar, nombre: @evento_deportivo.nombre }
    end
  ...
  test "should update evento_deportivo" do
    put :update, id: @evento_deportivo, evento_deportivo: { detalles_adicionales: @evento_deportivo.detalles_adicionales, fecha_fin: @evento_deportivo.fecha_fin, fecha_inicio: @evento_deportivo.fecha_inicio, horario: @evento_deportivo.horario, lugar: @evento_deportivo.lugar, nombre: @evento_deportivo.nombre }
    assert_redirected_to evento_deportivo_path(assigns(:evento_deportivo))
  end
